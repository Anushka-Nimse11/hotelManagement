...
function CoffeeTea() {
  ...
  return (
    <div className="p-6 border-2 border-[#CC9F35D6] m-10">
      <h1 className="text-center text-4xl mb-5">Tea & Coffee</h1>

      <Section title="Classic Hot Tea" items={ClassicHotTea} />
      <Section title="Classic Coffees" items={ClassicCoffees} />
      <Section title="Milk-Based Coffees" items={MilkBasedCoffees} />
      <Section title="Special Italian Coffees" items={SpecialItalianCoffees} />
    </div>
  );
}

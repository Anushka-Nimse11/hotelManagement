...
import {
  ClassicItalianDesserts,
  CakesPastries,
  RegionalItalianDesserts,
  ColdLightDesserts,
} from "../Data/ImageList";
...
function Dessert() {
  ...
  return (
    <div className="p-6 border-2 border-[#CC9F35D6] m-10">
      <h1 className="text-center text-4xl mb-5">Italian Desserts</h1>

      <Section
        title="Classic Italian Desserts"
        items={ClassicItalianDesserts}
      />
      <Section title="Cakes & Pastries" items={CakesPastries} />
      <Section
        title="Regional Italian Desserts"
        items={RegionalItalianDesserts}
      />
      <Section title="Cold / Light Desserts" items={ColdLightDesserts} />
    </div>
  );
}

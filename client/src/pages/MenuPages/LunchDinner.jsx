...
function LunchDinner() {
  ...
  return (
    <div className="p-6 border-2 border-[#CC9F35D6] m-10">
      <h1 className="text-center text-4xl mb-5">Italian Lunch & Dinner</h1>

      <Section title="Pasta Dishes" items={PastaDishes} />
      <Section title="Pizza Dishes" items={PizzaDishes} />
      <Section title="Salad / Light Meals" items={SaladLightMeals} />
      <Section title="Italian Main Courses" items={ItalianMainCourses} />
      <Section title="Rice Dishes" items={RiceOtherDishes} />
    </div>
  );
}
